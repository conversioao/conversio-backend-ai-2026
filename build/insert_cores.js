...
async function insertCores() {
    try {
        ...
        for (const core of newCores) {
            await query(`INSERT INTO models (name, type, category, style_id, description, is_active, credit_cost, sort_order)
                 VALUES ($1, $2, $3, $4, $5, $6, $7, $8)`, [core.name, 'image', 'core', core.style_id, core.description, true, 0, core.sort_order]);
