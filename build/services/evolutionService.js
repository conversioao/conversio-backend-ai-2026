...
export class EvolutionService {
     ...
     */
    static async setWebhook(instanceName = DEFAULT_INSTANCE) {
        try {
     ...
     */
    static async getQRCode(instanceName = DEFAULT_INSTANCE) {
        try {
     ...
     * Logout da instância
     */
    static async logout(instanceName = DEFAULT_INSTANCE) {
        try {
